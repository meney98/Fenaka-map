...
function clearBlockSelection(){ if(selectedBlock){ selectedBlock.style.filter=''; selectedBlock.style.stroke=''; selectedBlock.style.strokeWidth=''; selectedBlock.style.fill=''; selectedBlock=null; } }
...
function focusBlock(d){
  ...
  selectedBlock.style.stroke=''; selectedBlock.style.strokeWidth=''; selectedBlock.style.filter='drop-shadow(0 0 12px rgba(0,120,255,.95))'; selectedBlock.style.fill='#2196f3'; selectedBlock.dataset.prevFill=selectedBlock.dataset.prevFill||'';
...
fetch('map.svg',{cache:'no-store'}).then(r=>r.text()).then(txt=>{
  ...
  for(const el of svg.querySelectorAll('path')){
    ...
    el.addEventListener('click',ev=>{
      ...
      el.style.stroke=''; el.style.strokeWidth=''; el.style.filter='drop-shadow(0 0 12px rgba(0,120,255,.95))'; el.style.fill='#2196f3';
